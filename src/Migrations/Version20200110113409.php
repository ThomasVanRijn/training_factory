 ...
 */
final class Version20200110113409 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE lesson ADD training_id_id INT DEFAULT NULL');
